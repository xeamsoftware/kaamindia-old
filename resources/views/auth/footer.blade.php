...
<!-- Auth-modal-box -->
<div class="modal fade auth-modal" id="authmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                        ...
                        <div class="col-lg-4">
                            <div class="sign-box">
                                <div class="sign-data-box">
                                    ...
                                    <div class="sign-text">
                                        <h5>Sign up as a Consultant</h5>
                                        <p>Let's work together</p>
                                    </div>
                                </div>
                                <div class="sign-btn-box">
                                    <a href="{{url('/signup-consultant')}}" class="default-btn">Register now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
